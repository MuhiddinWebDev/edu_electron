...
const END_POINT = '/partiya'

class PartiyaService {
  getAll() {
  ...
  getByFoodResource(id) {
    return axios.get(END_POINT + `/by-food-resource/${id}`).then((res) => {
        return res.data
    })
  }
  getOne(id) {
...
export default new PartiyaService()
