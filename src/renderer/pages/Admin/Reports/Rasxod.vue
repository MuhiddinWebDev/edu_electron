...
const showReport = () => {
  ...
  loading.value = true;
  ReportService.rasxodReport(sendData).then((res) => {
    ...
    <div class="box-table">
      <n-table :bordered="true" :single-line="false" size="small">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="4" class="text-center text-bold">Jami</td>
            <td class="text-right text-bold">
              {{
                Intl.NumberFormat("ru-RU", {
                  style: "decimal",
          ...
          <tr>
            <td class="text-center text-bold" colspan="4">Yakuniy qoldiq</td>
            <td class="text-right text-bold">
              {{
                Intl.NumberFormat("ru-RU", {
                  style: "decimal",
