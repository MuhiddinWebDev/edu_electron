...
<script setup>
import FooGroupService from "../../../services/food-group.service";
import { onMounted, ref, h } from "vue";
import { NButton, NIcon, useDialog, useMessage } from "naive-ui";
import { Pencil, Trash, Plus } from "@vicons/tabler";
import FormFoodGroup from "./FormFoodGroup.vue";
const emits = defineEmits(["rowClick", "createFoodGroup"]);
...
const getAll = () => {
  FooGroupService.getAll().then((res) => {
    tableData.value = res;
  });
};
          ...
          NButton,
          {
            ...
            onClick: (e) => {
              ...
              dialog.success({
                ...
                negativeText: "Yo'q",
                onPositiveClick: () => {
                  FooGroupService.delete(row.id).then((res) => {
                    getAll();
