<template>
  ...
  import Form from "./FormPayCaisher.vue";
  ...
  const getAll = () => {
    PayCaisherService.getAll().then((res) => {
      tableData.value = res;
    });
  };
            ...
            NButton,
            {
              ...
              onClick: (e) => {
                ...
                dialog.success({
                  ...
                  negativeText: "Yo'q",
                  onPositiveClick: () => {
                    PayCaisherService.delete(row.id).then((res) => {
                      getAll();
